...
![将查找右边界转化为查找左边界](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_searching/binary_search_edge.assets/binary_search_right_edge_by_left_edge.png)
...
![将查找边界转化为查找元素](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_searching/binary_search_edge.assets/binary_search_edge_by_element.png)
