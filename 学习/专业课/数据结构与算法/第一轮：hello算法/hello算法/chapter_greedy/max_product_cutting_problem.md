...
![最大切分乘积的问题定义](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_greedy/max_product_cutting_problem.assets/max_product_cutting_definition.png)
...
![切分导致乘积变大](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_greedy/max_product_cutting_problem.assets/max_product_cutting_greedy_infer1.png)
...
![最优切分因子](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_greedy/max_product_cutting_problem.assets/max_product_cutting_greedy_infer2.png)
...
![最大切分乘积的计算方法](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_greedy/max_product_cutting_problem.assets/max_product_cutting_greedy_calculation.png)
