...
![零钱兑换的贪心策略](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_greedy/greedy_algorithm.assets/coin_change_greedy_strategy.png)
...
![贪心算法无法找出最优解的示例](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_greedy/greedy_algorithm.assets/coin_change_greedy_vs_dp.png)
