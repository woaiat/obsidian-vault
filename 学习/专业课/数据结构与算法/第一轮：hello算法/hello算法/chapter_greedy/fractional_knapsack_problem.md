...
![分数背包问题的示例数据](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_greedy/fractional_knapsack_problem.assets/fractional_knapsack_example.png)
...
![物品在单位重量下的价值](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_greedy/fractional_knapsack_problem.assets/fractional_knapsack_unit_value.png)
...
![分数背包问题的贪心策略](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_greedy/fractional_knapsack_problem.assets/fractional_knapsack_greedy_strategy.png)
...
![分数背包问题的几何表示](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_greedy/fractional_knapsack_problem.assets/fractional_knapsack_area_chart.png)
