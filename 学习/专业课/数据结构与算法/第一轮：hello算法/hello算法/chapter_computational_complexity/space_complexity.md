...
![算法使用的相关空间](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_computational_complexity/space_complexity.assets/space_types.png)
...
![常见的空间复杂度类型](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_computational_complexity/space_complexity.assets/space_complexity_common_types.png)
...
![递归函数产生的线性阶空间复杂度](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_computational_complexity/space_complexity.assets/space_complexity_recursive_linear.png)
...
![递归函数产生的平方阶空间复杂度](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_computational_complexity/space_complexity.assets/space_complexity_recursive_quadratic.png)
...
![满二叉树产生的指数阶空间复杂度](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_computational_complexity/space_complexity.assets/space_complexity_exponential.png)
