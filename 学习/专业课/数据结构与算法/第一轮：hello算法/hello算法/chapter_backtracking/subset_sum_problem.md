...
![子集搜索与越界剪枝](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_backtracking/subset_sum_problem.assets/subset_sum_i_naive.png)
...
![不同选择顺序导致的重复子集](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_backtracking/subset_sum_problem.assets/subset_sum_i_pruning.png)
...
![子集和 I 回溯过程](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_backtracking/subset_sum_problem.assets/subset_sum_i.png)
...
![相等元素导致的重复子集](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_backtracking/subset_sum_problem.assets/subset_sum_ii_repeat.png)
...
![子集和 II 回溯过程](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_backtracking/subset_sum_problem.assets/subset_sum_ii.png)
