...
![4 皇后问题的解](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_backtracking/n_queens_problem.assets/solution_4_queens.png)

下图展示了本题的三个约束条件：**多个皇后不能在同一行、同一列、同一条对角线上**。值得注意的是，对角线分为主对角线 `\` 和次对角线 `/` 两种。

![n 皇后问题的约束条件](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_backtracking/n_queens_problem.assets/n_queens_constraints.png)
...
![逐行放置策略](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_backtracking/n_queens_problem.assets/n_queens_placing.png)
...
![处理列约束和对角线约束](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_backtracking/n_queens_problem.assets/n_queens_cols_diagonals.png)
