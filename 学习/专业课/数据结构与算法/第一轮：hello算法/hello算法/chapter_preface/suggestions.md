...
![动画图解示例](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/index.assets/animation.gif)
...
![运行代码示例](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/index.assets/running_code.gif)
...
![克隆仓库与下载代码](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_preface/suggestions.assets/download_code.png)

**第三步：运行源代码**。如下图所示，对于顶部标有文件名称的代码块，我们可以在仓库的 `codes` 文件夹内找到对应的源代码文件。源代码文件可一键运行，将帮助你节省不必要的调试时间，让你能够专注于学习内容。

![代码块与对应的源代码文件](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_preface/suggestions.assets/code_md_to_repo.png)
...
![Python 代码的可视化运行](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_preface/suggestions.assets/pythontutor_example.png)
...
![评论区示例](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/index.assets/comment.gif)
...
![算法学习路线](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_preface/suggestions.assets/learning_route.png)
