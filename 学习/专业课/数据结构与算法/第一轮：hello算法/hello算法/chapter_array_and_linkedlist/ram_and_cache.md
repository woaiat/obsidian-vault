...
![计算机存储系统](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_array_and_linkedlist/ram_and_cache.assets/storage_pyramid.png)
...
![硬盘、内存和缓存之间的数据流通](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_array_and_linkedlist/ram_and_cache.assets/computer_storage_devices.png)
