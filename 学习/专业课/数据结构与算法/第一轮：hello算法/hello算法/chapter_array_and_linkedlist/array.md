...
![数组定义与存储方式](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_array_and_linkedlist/array.assets/array_definition.png)
...
![数组元素的内存地址计算](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_array_and_linkedlist/array.assets/array_memory_location_calculation.png)
...
![数组插入元素示例](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_array_and_linkedlist/array.assets/array_insert_element.png)
...
![数组删除元素示例](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_array_and_linkedlist/array.assets/array_remove_element.png)
