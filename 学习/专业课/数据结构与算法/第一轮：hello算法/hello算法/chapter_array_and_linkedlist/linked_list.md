...
![链表定义与存储方式](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_array_and_linkedlist/linked_list.assets/linkedlist_definition.png)
...
![链表插入节点示例](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_array_and_linkedlist/linked_list.assets/linkedlist_insert_node.png)
...
![链表删除节点](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_array_and_linkedlist/linked_list.assets/linkedlist_remove_node.png)
...
![常见链表种类](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_array_and_linkedlist/linked_list.assets/linkedlist_common_types.png)
