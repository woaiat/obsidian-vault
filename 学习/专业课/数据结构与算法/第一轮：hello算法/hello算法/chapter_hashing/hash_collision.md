...
![链式地址哈希表](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_hashing/hash_collision.assets/hash_table_chaining.png)
...
![开放寻址（线性探测）哈希表的键值对分布](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_hashing/hash_collision.assets/hash_table_linear_probing.png)
...
![在开放寻址中删除元素导致的查询问题](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_hashing/hash_collision.assets/hash_table_open_addressing_deletion.png)
