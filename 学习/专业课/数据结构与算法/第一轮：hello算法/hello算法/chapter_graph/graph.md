...
![链表、树、图之间的关系](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_graph/graph.assets/linkedlist_tree_graph.png)
...
![有向图与无向图](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_graph/graph.assets/directed_graph.png)
...
![连通图与非连通图](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_graph/graph.assets/connected_graph.png)

我们还可以为边添加“权重”变量，从而得到如下图所示的<u>有权图（weighted graph）</u>。例如在《王者荣耀》等手游中，系统会根据共同游戏时间来计算玩家之间的“亲密度”，这种亲密度网络就可以用有权图来表示。

![有权图与无权图](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_graph/graph.assets/weighted_graph.png)
...
![图的邻接矩阵表示](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_graph/graph.assets/adjacency_matrix.png)
...
![图的邻接表表示](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_graph/graph.assets/adjacency_list.png)
