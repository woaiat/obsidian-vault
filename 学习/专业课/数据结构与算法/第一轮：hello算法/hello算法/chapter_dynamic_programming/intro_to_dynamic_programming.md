...
![爬到第 3 阶的方案数量](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_dynamic_programming/intro_to_dynamic_programming.assets/climbing_stairs_example.png)
...
![方案数量递推关系](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_dynamic_programming/intro_to_dynamic_programming.assets/climbing_stairs_state_transfer.png)
...
![爬楼梯对应递归树](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_dynamic_programming/intro_to_dynamic_programming.assets/climbing_stairs_dfs_tree.png)
...
![记忆化搜索对应递归树](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_dynamic_programming/intro_to_dynamic_programming.assets/climbing_stairs_dfs_memo_tree.png)
...
![爬楼梯的动态规划过程](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_dynamic_programming/intro_to_dynamic_programming.assets/climbing_stairs_dp.png)
