...
![爬到第 3 阶的最小代价](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_dynamic_programming/dp_problem_features.assets/min_cost_cs_example.png)
...
![爬楼梯最小代价的动态规划过程](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_dynamic_programming/dp_problem_features.assets/min_cost_cs_dp.png)
...
![带约束爬到第 3 阶的方案数量](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_dynamic_programming/dp_problem_features.assets/climbing_stairs_constraint_example.png)
...
![考虑约束下的递推关系](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_dynamic_programming/dp_problem_features.assets/climbing_stairs_constraint_state_transfer.png)
