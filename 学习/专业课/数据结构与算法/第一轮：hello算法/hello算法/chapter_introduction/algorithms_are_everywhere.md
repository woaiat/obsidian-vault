...
=== "<1>"
    ![查字典步骤](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_introduction/algorithms_are_everywhere.assets/binary_search_dictionary_step1.png)

=== "<2>"
    ![binary_search_dictionary_step2](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_introduction/algorithms_are_everywhere.assets/binary_search_dictionary_step2.png)

=== "<3>"
    ![binary_search_dictionary_step3](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_introduction/algorithms_are_everywhere.assets/binary_search_dictionary_step3.png)

=== "<4>"
    ![binary_search_dictionary_step4](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_introduction/algorithms_are_everywhere.assets/binary_search_dictionary_step4.png)

=== "<5>"
    ![binary_search_dictionary_step5](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_introduction/algorithms_are_everywhere.assets/binary_search_dictionary_step5.png)
...
![扑克排序步骤](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_introduction/algorithms_are_everywhere.assets/playing_cards_sorting.png)
...
![货币找零过程](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_introduction/algorithms_are_everywhere.assets/greedy_change.png)
