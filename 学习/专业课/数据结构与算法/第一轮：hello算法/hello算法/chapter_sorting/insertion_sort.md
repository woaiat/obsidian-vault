...
![单次插入操作](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_sorting/insertion_sort.assets/insertion_operation.png)
...
![插入排序流程](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_sorting/insertion_sort.assets/insertion_sort_overview.png)
