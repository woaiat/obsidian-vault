...
![计数排序流程](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_sorting/counting_sort.assets/counting_sort_overview.png)
...
=== "<1>"
    ![计数排序步骤](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_sorting/counting_sort.assets/counting_sort_step1.png)

=== "<2>"
    ![counting_sort_step2](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_sorting/counting_sort.assets/counting_sort_step2.png)

=== "<3>"
    ![counting_sort_step3](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_sorting/counting_sort.assets/counting_sort_step3.png)

=== "<4>"
    ![counting_sort_step4](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_sorting/counting_sort.assets/counting_sort_step4.png)

=== "<5>"
    ![counting_sort_step5](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_sorting/counting_sort.assets/counting_sort_step5.png)

=== "<6>"
    ![counting_sort_step6](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_sorting/counting_sort.assets/counting_sort_step6.png)

=== "<7>"
    ![counting_sort_step7](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_sorting/counting_sort.assets/counting_sort_step7.png)

=== "<8>"
    ![counting_sort_step8](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_sorting/counting_sort.assets/counting_sort_step8.png)
