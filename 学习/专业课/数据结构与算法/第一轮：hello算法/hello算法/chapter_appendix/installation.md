...
![从官网下载 VS Code](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_appendix/installation.assets/vscode_installation.png)

VS Code 拥有强大的扩展包生态系统，支持大多数编程语言的运行和调试。以 Python 为例，安装“Python Extension Pack”扩展包之后，即可进行 Python 代码调试。安装步骤如下图所示。

![安装 VS Code 扩展包](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_appendix/installation.assets/vscode_extension_installation.png)
