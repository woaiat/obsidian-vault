...
![ASCII 码](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_data_structure/character_encoding.assets/ascii_table.png)
...
![Unicode 编码示例](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_data_structure/character_encoding.assets/unicode_hello_algo.png)
...
![UTF-8 编码示例](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_data_structure/character_encoding.assets/utf-8_hello_algo.png)
