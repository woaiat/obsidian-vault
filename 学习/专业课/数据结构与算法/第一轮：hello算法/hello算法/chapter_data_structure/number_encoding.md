...
![原码、反码与补码之间的相互转换](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_data_structure/number_encoding.assets/1s_2s_complement.png)
...
![IEEE 754 标准下的 float 的计算示例](学习/专业课/数据结构与算法/第一轮：hello算法/hello算法/chapter_data_structure/number_encoding.assets/ieee_754_float.png)
