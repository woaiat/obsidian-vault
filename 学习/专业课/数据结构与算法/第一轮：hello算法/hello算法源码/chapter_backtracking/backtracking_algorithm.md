...
![在前序遍历中搜索节点](preorder_find_nodes.png)
...
=== "<1>"
    ![尝试与回退](preorder_find_paths_step1.png)

=== "<2>"
    ![preorder_find_paths_step2](preorder_find_paths_step2.png)

=== "<3>"
    ![preorder_find_paths_step3](preorder_find_paths_step3.png)

=== "<4>"
    ![preorder_find_paths_step4](preorder_find_paths_step4.png)

=== "<5>"
    ![preorder_find_paths_step5](preorder_find_paths_step5.png)

=== "<6>"
    ![preorder_find_paths_step6](preorder_find_paths_step6.png)

=== "<7>"
    ![preorder_find_paths_step7](preorder_find_paths_step7.png)

=== "<8>"
    ![preorder_find_paths_step8](preorder_find_paths_step8.png)

=== "<9>"
    ![preorder_find_paths_step9](preorder_find_paths_step9.png)

=== "<10>"
    ![preorder_find_paths_step10](preorder_find_paths_step10.png)

=== "<11>"
    ![preorder_find_paths_step11](preorder_find_paths_step11.png)
...
![根据约束条件剪枝](preorder_find_constrained_paths.png)
...
![保留与删除 return 的搜索过程对比](backtrack_remove_return_or_not.png)
