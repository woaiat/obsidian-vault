...
![子集搜索与越界剪枝](subset_sum_i_naive.png)
...
![不同选择顺序导致的重复子集](subset_sum_i_pruning.png)
...
![相等元素导致的重复子集](subset_sum_ii_repeat.png)
