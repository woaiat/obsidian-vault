...
=== "<1>"
    ![规模为 1 的问题的解](hanota_f1_step1.png)

=== "<2>"
    ![hanota_f1_step2](hanota_f1_step2.png)
...
=== "<1>"
    ![规模为 2 的问题的解](hanota_f2_step1.png)

=== "<2>"
    ![hanota_f2_step2](hanota_f2_step2.png)

=== "<3>"
    ![hanota_f2_step3](hanota_f2_step3.png)

=== "<4>"
    ![hanota_f2_step4](hanota_f2_step4.png)
...
=== "<1>"
    ![规模为 3 的问题的解](hanota_f3_step1.png)

=== "<2>"
    ![hanota_f3_step2](hanota_f3_step2.png)

=== "<3>"
    ![hanota_f3_step3](hanota_f3_step3.png)

=== "<4>"
    ![hanota_f3_step4](hanota_f3_step4.png)
...
![解决汉诺塔问题的分治策略](hanota_divide_and_conquer.png)
...
![汉诺塔问题的递归树](hanota_recursive_tree.png)
