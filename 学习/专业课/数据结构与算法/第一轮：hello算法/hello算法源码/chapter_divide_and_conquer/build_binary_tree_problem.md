...
![构建二叉树的示例数据](build_tree_example.png)
...
![在前序遍历和中序遍历中划分子树](build_tree_preorder_inorder_division.png)
...
![根节点和左右子树的索引区间表示](build_tree_division_pointers.png)
...
=== "<1>"
    ![构建二叉树的递归过程](built_tree_step1.png)

=== "<2>"
    ![built_tree_step2](built_tree_step2.png)

=== "<3>"
    ![built_tree_step3](built_tree_step3.png)

=== "<4>"
    ![built_tree_step4](built_tree_step4.png)

=== "<5>"
    ![built_tree_step5](built_tree_step5.png)

=== "<6>"
    ![built_tree_step6](built_tree_step6.png)

=== "<7>"
    ![built_tree_step7](built_tree_step7.png)

=== "<8>"
    ![built_tree_step8](built_tree_step8.png)

=== "<9>"
    ![built_tree_step9](built_tree_step9.png)

每个递归函数内的前序遍历 `preorder` 和中序遍历 `inorder` 的划分结果如下图所示。

![每个递归函数中的划分结果](built_tree_overall.png)
