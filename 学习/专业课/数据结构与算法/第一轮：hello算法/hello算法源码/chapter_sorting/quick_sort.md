...
=== "<1>"
    ![哨兵划分步骤](pivot_division_step1.png)

=== "<2>"
    ![pivot_division_step2](pivot_division_step2.png)

=== "<3>"
    ![pivot_division_step3](pivot_division_step3.png)

=== "<4>"
    ![pivot_division_step4](pivot_division_step4.png)

=== "<5>"
    ![pivot_division_step5](pivot_division_step5.png)

=== "<6>"
    ![pivot_division_step6](pivot_division_step6.png)

=== "<7>"
    ![pivot_division_step7](pivot_division_step7.png)

=== "<8>"
    ![pivot_division_step8](pivot_division_step8.png)

=== "<9>"
    ![pivot_division_step9](pivot_division_step9.png)
...
![快速排序流程](quick_sort_overview.png)
