...
![完全背包问题的示例数据](unbounded_knapsack_example.png)
...
=== "<1>"
    ![完全背包问题在空间优化后的动态规划过程](unbounded_knapsack_dp_comp_step1.png)

=== "<2>"
    ![unbounded_knapsack_dp_comp_step2](unbounded_knapsack_dp_comp_step2.png)

=== "<3>"
    ![unbounded_knapsack_dp_comp_step3](unbounded_knapsack_dp_comp_step3.png)

=== "<4>"
    ![unbounded_knapsack_dp_comp_step4](unbounded_knapsack_dp_comp_step4.png)

=== "<5>"
    ![unbounded_knapsack_dp_comp_step5](unbounded_knapsack_dp_comp_step5.png)

=== "<6>"
    ![unbounded_knapsack_dp_comp_step6](unbounded_knapsack_dp_comp_step6.png)
...
![零钱兑换问题的示例数据](coin_change_example.png)
...
=== "<1>"
    ![零钱兑换问题的动态规划过程](coin_change_dp_step1.png)

=== "<2>"
    ![coin_change_dp_step2](coin_change_dp_step2.png)

=== "<3>"
    ![coin_change_dp_step3](coin_change_dp_step3.png)

=== "<4>"
    ![coin_change_dp_step4](coin_change_dp_step4.png)

=== "<5>"
    ![coin_change_dp_step5](coin_change_dp_step5.png)

=== "<6>"
    ![coin_change_dp_step6](coin_change_dp_step6.png)

=== "<7>"
    ![coin_change_dp_step7](coin_change_dp_step7.png)

=== "<8>"
    ![coin_change_dp_step8](coin_change_dp_step8.png)

=== "<9>"
    ![coin_change_dp_step9](coin_change_dp_step9.png)

=== "<10>"
    ![coin_change_dp_step10](coin_change_dp_step10.png)

=== "<11>"
    ![coin_change_dp_step11](coin_change_dp_step11.png)

=== "<12>"
    ![coin_change_dp_step12](coin_change_dp_step12.png)

=== "<13>"
    ![coin_change_dp_step13](coin_change_dp_step13.png)

=== "<14>"
    ![coin_change_dp_step14](coin_change_dp_step14.png)

=== "<15>"
    ![coin_change_dp_step15](coin_change_dp_step15.png)
...
![零钱兑换问题 II 的示例数据](coin_change_ii_example.png)
