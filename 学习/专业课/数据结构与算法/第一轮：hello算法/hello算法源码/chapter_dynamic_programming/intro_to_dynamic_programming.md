...
![爬到第 3 阶的方案数量](climbing_stairs_example.png)
...
![方案数量递推关系](climbing_stairs_state_transfer.png)
...
![爬楼梯对应递归树](climbing_stairs_dfs_tree.png)
...
![记忆化搜索对应递归树](climbing_stairs_dfs_memo_tree.png)
...
![爬楼梯的动态规划过程](climbing_stairs_dp.png)
