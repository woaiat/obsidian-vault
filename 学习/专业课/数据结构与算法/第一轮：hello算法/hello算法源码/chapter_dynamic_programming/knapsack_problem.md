...
![0-1 背包的示例数据](knapsack_example.png)
...
![0-1 背包问题的暴力搜索递归树](knapsack_dfs.png)
...
=== "<1>"
    ![0-1 背包问题的动态规划过程](knapsack_dp_step1.png)

=== "<2>"
    ![knapsack_dp_step2](knapsack_dp_step2.png)

=== "<3>"
    ![knapsack_dp_step3](knapsack_dp_step3.png)

=== "<4>"
    ![knapsack_dp_step4](knapsack_dp_step4.png)

=== "<5>"
    ![knapsack_dp_step5](knapsack_dp_step5.png)

=== "<6>"
    ![knapsack_dp_step6](knapsack_dp_step6.png)

=== "<7>"
    ![knapsack_dp_step7](knapsack_dp_step7.png)

=== "<8>"
    ![knapsack_dp_step8](knapsack_dp_step8.png)

=== "<9>"
    ![knapsack_dp_step9](knapsack_dp_step9.png)

=== "<10>"
    ![knapsack_dp_step10](knapsack_dp_step10.png)

=== "<11>"
    ![knapsack_dp_step11](knapsack_dp_step11.png)

=== "<12>"
    ![knapsack_dp_step12](knapsack_dp_step12.png)

=== "<13>"
    ![knapsack_dp_step13](knapsack_dp_step13.png)

=== "<14>"
    ![knapsack_dp_step14](knapsack_dp_step14.png)
...
=== "<1>"
    ![0-1 背包的空间优化后的动态规划过程](knapsack_dp_comp_step1.png)

=== "<2>"
    ![knapsack_dp_comp_step2](knapsack_dp_comp_step2.png)

=== "<3>"
    ![knapsack_dp_comp_step3](knapsack_dp_comp_step3.png)

=== "<4>"
    ![knapsack_dp_comp_step4](knapsack_dp_comp_step4.png)

=== "<5>"
    ![knapsack_dp_comp_step5](knapsack_dp_comp_step5.png)

=== "<6>"
    ![knapsack_dp_comp_step6](knapsack_dp_comp_step6.png)
