...
=== "<1>"
    ![查字典步骤](binary_search_dictionary_step1.png)

=== "<2>"
    ![binary_search_dictionary_step2](binary_search_dictionary_step2.png)

=== "<3>"
    ![binary_search_dictionary_step3](binary_search_dictionary_step3.png)

=== "<4>"
    ![binary_search_dictionary_step4](binary_search_dictionary_step4.png)

=== "<5>"
    ![binary_search_dictionary_step5](binary_search_dictionary_step5.png)
...
![扑克排序步骤](playing_cards_sorting.png)
