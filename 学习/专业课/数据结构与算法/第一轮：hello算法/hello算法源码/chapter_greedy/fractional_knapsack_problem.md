...
![分数背包问题的示例数据](fractional_knapsack_example.png)
...
![物品在单位重量下的价值](fractional_knapsack_unit_value.png)
...
![分数背包问题的贪心策略](fractional_knapsack_greedy_strategy.png)
...
![分数背包问题的几何表示](fractional_knapsack_area_chart.png)
