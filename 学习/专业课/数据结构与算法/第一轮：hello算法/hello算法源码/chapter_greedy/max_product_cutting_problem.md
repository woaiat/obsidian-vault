...
![最大切分乘积的问题定义](max_product_cutting_definition.png)
...
![切分导致乘积变大](max_product_cutting_greedy_infer1.png)
...
![最优切分因子](max_product_cutting_greedy_infer2.png)
...
![最大切分乘积的计算方法](max_product_cutting_greedy_calculation.png)
