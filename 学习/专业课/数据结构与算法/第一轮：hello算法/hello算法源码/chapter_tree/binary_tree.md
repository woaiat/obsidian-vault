...
![父节点、子节点、子树](binary_tree_definition.png)
...
![二叉树的常用术语](binary_tree_terminology.png)
...
![在二叉树中插入与删除节点](binary_tree_add_remove.png)
...
![二叉树的最佳结构与最差结构](binary_tree_best_worst_cases.png)
