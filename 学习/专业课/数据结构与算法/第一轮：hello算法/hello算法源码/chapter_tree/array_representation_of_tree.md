...
![完美二叉树的数组表示](array_representation_binary_tree.png)
...
![层序遍历序列对应多种二叉树可能性](array_representation_without_empty.png)
...
![任意类型二叉树的数组表示](array_representation_with_empty.png)

值得说明的是，**完全二叉树非常适合使用数组来表示**。回顾完全二叉树的定义，`None` 只出现在最底层且靠右的位置，**因此所有 `None` 一定出现在层序遍历序列的末尾**。

这意味着使用数组表示完全二叉树时，可以省略存储所有 `None` ，非常方便。下图给出了一个例子。

![完全二叉树的数组表示](array_representation_complete_binary_tree.png)
