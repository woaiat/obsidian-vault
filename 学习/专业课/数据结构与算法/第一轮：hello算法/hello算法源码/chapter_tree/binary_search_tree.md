...
=== "<1>"
    ![二叉搜索树查找节点示例](bst_search_step1.png)

=== "<2>"
    ![bst_search_step2](bst_search_step2.png)

=== "<3>"
    ![bst_search_step3](bst_search_step3.png)

=== "<4>"
    ![bst_search_step4](bst_search_step4.png)
...
![在二叉搜索树中删除节点（度为 0 ）](bst_remove_case1.png)

如下图所示，当待删除节点的度为 $1$ 时，将待删除节点替换为其子节点即可。

![在二叉搜索树中删除节点（度为 1 ）](bst_remove_case2.png)
...
=== "<1>"
    ![在二叉搜索树中删除节点（度为 2 ）](bst_remove_case3_step1.png)

=== "<2>"
    ![bst_remove_case3_step2](bst_remove_case3_step2.png)

=== "<3>"
    ![bst_remove_case3_step3](bst_remove_case3_step3.png)

=== "<4>"
    ![bst_remove_case3_step4](bst_remove_case3_step4.png)
...
![二叉搜索树的中序遍历序列](bst_inorder_traversal.png)
