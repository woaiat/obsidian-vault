...
![二分查找示例数据](binary_search_example.png)
...
=== "<1>"
    ![二分查找流程](binary_search_step1.png)

=== "<2>"
    ![binary_search_step2](binary_search_step2.png)

=== "<3>"
    ![binary_search_step3](binary_search_step3.png)

=== "<4>"
    ![binary_search_step4](binary_search_step4.png)

=== "<5>"
    ![binary_search_step5](binary_search_step5.png)

=== "<6>"
    ![binary_search_step6](binary_search_step6.png)

=== "<7>"
    ![binary_search_step7](binary_search_step7.png)
...
![两种区间定义](binary_search_ranges.png)
