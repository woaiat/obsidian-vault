...
=== "LinkedListStack"
    ![基于链表实现栈的入栈出栈操作](linkedlist_stack_step1.png)

=== "push()"
    ![linkedlist_stack_push](linkedlist_stack_step2_push.png)

=== "pop()"
    ![linkedlist_stack_pop](linkedlist_stack_step3_pop.png)
...
=== "ArrayStack"
    ![基于数组实现栈的入栈出栈操作](array_stack_step1.png)

=== "push()"
    ![array_stack_push](array_stack_step2_push.png)

=== "pop()"
    ![array_stack_pop](array_stack_step3_pop.png)
